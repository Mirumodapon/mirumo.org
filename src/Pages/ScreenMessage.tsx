...
import { ChangeEventHandler, ChangeEvent, RefObject } from 'react';
...
const Textarea = styled.textarea`
  ...
  ${(props: { fontColor: string; background: string }) => `
...
function ScreenMessage(): JSX.Element {
  const textarea: RefObject<HTMLTextAreaElement> = useRef<HTMLTextAreaElement>(null);
  const span: RefObject<HTMLSpanElement> = useRef<HTMLSpanElement>(null);
